...
import { HomeIcon, BuildingOfficeIcon, CogIcon } from '@heroicons/react/24/outline';
  ...
  const services = [
    {
      ...
      description: 'Custom homes, renovations, and residential developments built to exceed expectations.',
      icon: HomeIcon,
    },
    {
  ...
  return (
    <div className="bg-white">
        ...
        <div className="mx-auto max-w-4xl px-6 py-32 sm:py-48 lg:py-56 lg:px-8">
          <div className="text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-white drop-shadow-md">
              Professional construction services with 40+ years of excellence in residential, commercial, and industrial projects.
            </p>
      ...
      <div className="bg-[#F1F5F9] py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-[#FF6B35]">Excellence Since 1985</h2>
            ...
            <p className="mt-6 text-lg leading-8 text-[#4A5568]">
              BP Construction has been at the forefront of construction innovation, delivering high-quality projects that stand the test of time. Our commitment to excellence and client satisfaction has made us a leader in the industry.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-[#FF6B35]">Our Services</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-[#0A2540] sm:text-4xl">
              ...
              {services.map((service) => (
                <div key={service.name} className="flex flex-col">
                  <dt className="flex items-center gap-x-3 text-base font-semibold leading-7 text-[#0A2540]">
                    <service.icon className="h-5 w-5 flex-none text-[#FF6B35]" aria-hidden="true" />
                    {service.name}
                  </dt>
      ...
      <div className="bg-[#F1F5F9] py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl text-center">
            <h2 className="text-3xl font-bold tracking-tight text-[#0A2540] sm:text-4xl">Recent Projects</h2>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-xl text-center">
            <h2 className="text-lg font-semibold leading-8 tracking-tight text-[#FF6B35]">Testimonials</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-[#0A2540] sm:text-4xl">
                ...
                >
                  <figure className="rounded-2xl bg-[#F1F5F9] p-8 text-sm leading-6">
                    ...
                    <figcaption className="mt-6 flex items-center gap-x-4">
                      ...
                      />
                      <div>
                        <div className="font-semibold text-[#0A2540]">{testimonial.author.name}</div>
                        <div className="text-[#64748B]">{`${testimonial.author.handle}, ${testimonial.author.company}`}</div>
                      </div>
                    </figcaption>
                  </figure>
                </div>
